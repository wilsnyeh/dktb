        ...
        <>
            <div>
                ...
                <div className='m-5'>
                    ...
                    <div  style={{ justifyContent: "space-around" }} className=''>
                        {favorites.parks
                            ? <div className='list-column'>{favorites.parks.map((park) => {
                                return (
                                    <div key={park.id} className='card mb-5 mx-2 shad_bottom off_white list-border'>
                                        <div className="col">
                                            <div className="card-body">
                                                ...
                                                <h4 className="card-subtitle mb-2 text-muted">{park.city}</h4>
