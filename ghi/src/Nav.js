...
function Nav({ logout, token }) {
  return (
    <div>
    <nav class="navbar navbar-expand-lg py-3 navbar-dark mm-custom">
    <div class="container-fluid">
          {!token ?

            <NavLink className="navbar-brand ms-auto" to='/'><img src="https://i.ibb.co/93bxhLq/DKTB-logo-TEXTpng.png" alt=""/></NavLink>
            : <NavLink className="navbar-brand" to='/parks'><img src="https://i.ibb.co/93bxhLq/DKTB-logo-TEXTpng.png" alt=""/></NavLink>
          }
